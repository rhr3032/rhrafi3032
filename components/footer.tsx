                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 md:gap-12 relative p-8 md:p-12 overflow-hidden pb-32 md:pb-42 bg-linear-to-t from-orange-50 to-orange-100 rounded-t-2xl">
                    ...
                    <AnimatedContent distance={40} className="max-w-72">
                        ...
                        <p className="text-zinc-500 mt-4 pb-6">
                            <span>I don&#39;t just build screens,</span>
                            <br />
                            <span> I craft user experiences.</span>
                        </p>
                    ...
                    <div>
                        ...
                        <AnimatedContent className="flex flex-col mt-6 gap-3">
                            <a href="https://www.linkedin.com/in/rhr3032/" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <LinkedinIcon size={20} />
                                <p>LinkedIn</p>
                            </a>
                            <a href="https://www.behance.net/rhr3032" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <PenToolIcon size={20} />
                                <p>Behance</p>
                            </a>
                            <a href="https://dribbble.com/rhr3032" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <DribbbleIcon size={20} />
                                <p>Dribbble</p>
                            </a>
                            <a href="https://github.com/rhr3032" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <GithubIcon size={20} />
                                <p>GitHub</p>
                            </a>
                            <a href="https://www.pinterest.com/rhr3032" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <PinIcon size={20} />
                                <p>Pinterest</p>
                            </a>
                            <a href="https://www.instagram.com/nuysdev" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
                                <InstagramIcon size={20} />
                                <p>Instagram</p>
                            </a>
                            <a href="https://rhr3032.gumroad.com/" className="flex items-center gap-2 text-orange-500" target="_blank" rel="noopener noreferrer">
