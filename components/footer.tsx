...
import { ArrowUpIcon, InstagramIcon, LinkedinIcon, TwitterIcon } from "lucide-react";
                ...
                <div className="flex flex-col md:flex-row items-start justify-between relative p-8 md:p-12 overflow-hidden pb-32 md:pb-42 bg-linear-to-t from-orange-50 to-orange-100 rounded-t-2xl">
                    ...
                    <AnimatedContent distance={40} className="max-w-72">
                        ...
                        <p className="text-zinc-500 mt-4 pb-6">
                            Rafi Rahman is a UI/UX designer focused on research-led interfaces, scalable design systems and accessible experiences.
                        </p>
                        <p className="text-gray-500 py-0">Copyright 2026 © Rafi Rahman. All rights reserved.</p>
                    </AnimatedContent>
                    <div>
